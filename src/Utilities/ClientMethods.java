...
public class ClientMethods {
    ...
    public static void registerPatient(BufferedReader br, PrintWriter pw, JDBCManager userman,JDBCManager patientman,JDBCManager doctorman){
        try {
            //autogenerate username
            ...
            patientman.createLinkUserPatient(user.getId(), p.getMedCardId());
