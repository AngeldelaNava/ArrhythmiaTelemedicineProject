        ...
        try {
            ...
            while (true) {
                try {
                    ...
                    System.out.println("@@                                                                  @@");
                    System.out.println("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@");
                    System.out.println("Realizado por Angel De la Nava, Jaime Prats, Maria Rueda y Jaime Soler");
                    choice = sc.nextInt();
                    ...
                    switch (choice) {
                        ...
                        case 1:
                            register(bf, printWriter);//pasas bf para escribir y printWriter para la conexiÃ³n con servidor
                            break;
                        case 2:
